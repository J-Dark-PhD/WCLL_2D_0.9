...
# ##### Tungsten ######
#
# Taken from (P.Tolias, 2017) doi 10.1016/j.nme.2017.08.002
...
if __name__ == "__main__":
    ...
    plt.annotate(
        "EUROFER",
        (0.02 + 1000 / T[0], D_eurofer(T[0])),
        color=grey_eurofer,
        weight="bold",
    )
    plt.annotate(
        "LiPb", (0.02 + 1000 / T[0], D_lipb(T[0])), color=green_lipb, weight="bold"
    )
    plt.annotate("W", (0.02 + 1000 / T[0], D_W(T[0])), color=red_W, weight="bold")
